    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text=' Введте имя автора', max_length=100, verbose_name='Имя автор')),
                ('last_name', models.CharField(help_text=' Введте фамилию автора', max_length=100, verbose_name='Фамилия автора')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text=' Введте язык книги', max_length=30, verbose_name='Язык книги')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
